    ...
    return (
      <React.Fragment>
        ...
        >
          ...
          <ProgressTitle>
            <FormattedMessage
              id="koulutuksenJarjestaja.opiskelusuunnitelma.opinnotTitle"
              defaultMessage="Opiskelijan opinnot"
            />
          </ProgressTitle>
        ...
        >
          <Accordion
            ...
            title={
              <FormattedMessage
                id="koulutuksenJarjestaja.opiskelusuunnitelma.aikataulutetutOpinnotTitle"
                defaultMessage="Aikataulutetut opinnot ({amount})"
          ...
          <Accordion
            ...
            title={
              <FormattedMessage
                id="koulutuksenJarjestaja.opiskelusuunnitelma.suunnitellutOpinnotTitle"
                defaultMessage="Suunnitellut opinnot ({amount})"
          ...
          <Accordion
            ...
            title={
              <FormattedMessage
                id="koulutuksenJarjestaja.opiskelusuunnitelma.valmiitOpinnotTitle"
                defaultMessage="Valmiit opinnot ({amount})"
